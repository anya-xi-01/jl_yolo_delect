...
def save_one_box(xyxy, im, file='image.jpg', gain=1.02, pad=10, square=False, BGR=False, save=True):
    crop = crop_box(xyxy, im, gain, pad, square, BGR)
    if save:
...
def save_one_box_for_api(xyxy, im, file='image.jpg', gain=1.02, pad=10, square=False, BGR=False, save=True):
    crop = crop_box(xyxy, im, gain, pad, square, BGR)
    ret_path = str(increment_path(file).with_suffix('.jpg'))
    cv2.imwrite(ret_path, crop)
    return ret_path
